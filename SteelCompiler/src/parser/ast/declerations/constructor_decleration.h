...
class constructor_decleration : public ast_node, public std::enable_shared_from_this<constructor_decleration> {
public:
	ENABLE_ACCEPT(constructor_decleration)

	constructor_decleration(std::vector<std::shared_ptr<variable_decleration>> parameters, ast_ptr body)
