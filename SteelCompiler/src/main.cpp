...
int main(int argc, char** argv) {
	...
	stproj_file proj = stproj_file::load(R"(C:\Users\maxmt\source\repos\Steel\SteelCompiler\demo\demo.stproj)");
	compiler compiler;
	...
	interpreter.add_builtin_function(
		"Print",
		to_data_type(TT_VOID),
		{ std::make_shared<variable_declaration>(to_data_type(TT_INT), "message") }
	);
	interpreter.add_builtin_function(
		"Print",
		to_data_type(TT_VOID),
